...
Open [http://localhost:8080](http://localhost:8080) in your browser to access the ebot UI.
...
For additional installation options, see the Installation Guide at [https://docs.expedient.cloud/ebot/installation/general](https://docs.expedient.cloud/ebot/installation/general).
...
ebot addresses these challenges by offering MCP hosting, an MCP registry, an MCP gateway, and an MCP-standards-compliant chat client. Popular workflow and agent frameworks such as n8n and LangGraph can interact with MCP servers managed by ebot. In addition, clients like ChatGPT, Claude Desktop, and GitHub Copilot can also leverage MCP servers managed by ebot.

### MCP Hosting

Run and manage MCP servers directly within ebot:
...
Documentation is available at [https://docs.expedient.cloud/ebot](https://docs.expedient.cloud/ebot).

## Community

* Documentation: [https://docs.expedient.cloud/ebot](https://docs.expedient.cloud/ebot)
* Support: Contact Expedient Cloud Support

## Acknowledgments

ebot is a fork of the excellent [Obot platform](https://github.com/obot-platform/obot) by the Obot team, customized for Expedient's enterprise needs.

## License

ebot is open-source software. See the LICENSE file for details.
